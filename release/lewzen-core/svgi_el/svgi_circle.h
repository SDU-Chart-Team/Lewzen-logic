...
namespace Lewzen {
    ...
    */
    ...
    private:
        ...
        using SVGCircle::get_cx;
        using SVGCircle::set_cx;
        using SVGCircle::get_cy;
        using SVGCircle::set_cy;
        using SVGCircle::get_r;
        using SVGCircle::set_r;
        using SVGCircle::get_path_length;
        using SVGCircle::set_path_length;
