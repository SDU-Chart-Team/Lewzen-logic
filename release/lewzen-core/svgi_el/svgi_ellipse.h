...
namespace Lewzen {
    ...
    */
    ...
    private:
        ...
        using SVGEllipse::get_cx;
        using SVGEllipse::set_cx;
        using SVGEllipse::get_cy;
        using SVGEllipse::set_cy;
        using SVGEllipse::get_rx;
        using SVGEllipse::set_rx;
        using SVGEllipse::get_ry;
        using SVGEllipse::set_ry;
        using SVGEllipse::get_path_length;
        using SVGEllipse::set_path_length;
