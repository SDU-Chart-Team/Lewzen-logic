#ifndef __LZ_SVGI_SVG__
#define __LZ_SVGI_SVG__
#include "../svgi_el.h"
...
namespace Lewzen {
    ...
    */
    class SVGISvg : public virtual SVGIElement, public virtual SVGSvg {
    public:
        /**
    ...
    private:
        ...
        using SVGSvg::get_y;
        using SVGSvg::set_y;
        using SVGSvg::get_width;
        using SVGSvg::set_width;
        using SVGSvg::get_height;
        using SVGSvg::set_height;
        using SVGSvg::get_preserve_aspect_ratio;
        using SVGSvg::set_preserve_aspect_ratio;
        using SVGSvg::get_view_box;
        using SVGSvg::set_view_box;
    ...
    private:
        ...
        const std::array<std::function<const std::string()>, 6> _attr_commit = {
            ...
            [this](){
                if (SVGSvg::get_view_box() == ViewBox.get_commit()) return std::string("");
                ViewBox.commit();
    ...
    public:
        ...
        * @relatesalso SVGIElement
        */
        std::shared_ptr<SVGISvg> clone(bool identity) const;
        /**
        ...
        * @relatesalso SVGIElement
        */
        virtual SVGISvg &operator=(const SVGISvg &element);
        /**
