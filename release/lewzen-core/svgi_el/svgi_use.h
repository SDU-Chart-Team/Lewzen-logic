...
namespace Lewzen {
    ...
    */
    ...
    private:
        ...
        using SVGUse::get_href;
        using SVGUse::set_href;
        using SVGUse::get_x;
        using SVGUse::set_x;
        using SVGUse::get_y;
        using SVGUse::set_y;
        using SVGUse::get_width;
        using SVGUse::set_width;
        using SVGUse::get_height;
        using SVGUse::set_height;
