...
namespace Lewzen {
    ...
    */
    ...
    private:
        ...
        using SVGForeignObject::get_width;
        using SVGForeignObject::set_width;
        using SVGForeignObject::get_height;
        using SVGForeignObject::set_height;
        using SVGForeignObject::get_x;
        using SVGForeignObject::set_x;
        using SVGForeignObject::get_y;
        using SVGForeignObject::set_y;
