...
namespace Lewzen {
    ...
    */
    ...
    private:
        ...
        using SVGImage::get_width;
        using SVGImage::set_width;
        using SVGImage::get_height;
        using SVGImage::set_height;
        using SVGImage::get_x;
        using SVGImage::set_x;
        using SVGImage::get_y;
        using SVGImage::set_y;
        using SVGImage::get_href;
        using SVGImage::set_href;
        using SVGImage::get_xlinkZhref;
        using SVGImage::set_xlinkZhref;
        using SVGImage::get_preserve_aspect_ratio;
        using SVGImage::set_preserve_aspect_ratio;
        using SVGImage::get_crossorigin;
        using SVGImage::set_crossorigin;
