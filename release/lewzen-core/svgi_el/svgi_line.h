...
namespace Lewzen {
    ...
    */
    ...
    private:
        ...
        using SVGLine::get_xQ;
        using SVGLine::set_xQ;
        using SVGLine::get_xR;
        using SVGLine::set_xR;
        using SVGLine::get_yQ;
        using SVGLine::set_yQ;
        using SVGLine::get_yR;
        using SVGLine::set_yR;
        using SVGLine::get_path_length;
        using SVGLine::set_path_length;
