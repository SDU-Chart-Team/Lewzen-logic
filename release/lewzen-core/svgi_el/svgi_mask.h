...
namespace Lewzen {
    ...
    */
    ...
    private:
        ...
        using SVGMask::get_height;
        using SVGMask::set_height;
        using SVGMask::get_mask_content_units;
        using SVGMask::set_mask_content_units;
        using SVGMask::get_mask_units;
        using SVGMask::set_mask_units;
        using SVGMask::get_x;
        using SVGMask::set_x;
        using SVGMask::get_y;
        using SVGMask::set_y;
        using SVGMask::get_width;
        using SVGMask::set_width;
