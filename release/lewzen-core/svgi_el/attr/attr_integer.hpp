#ifndef __LZ_ATTR_INTEGER__
#define __LZ_ATTR_INTEGER__
#include <functional>
#include <string>
#include <memory>
#include <iostream>
...
namespace Lewzen {
    ...
    */
    ...
    public:
        /**
        * Empty constructor of Integer.
        */
        AttrInteger() {}
        /**
        * Constructor of Integer, with binding with getter and setter.
        *
        * @param getter getter function
        * @param setter setter function
        */
        AttrInteger(std::function<const std::string()> getter, std::function<void(const std::string &)> setter): _getter(getter), _setter(setter) {}
    ...
    public:
        ...
        */
        ...
        void set(const T &attr) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrInteger.set with no implementation. Reset value.")
        }
        /**
        * Set attribute from value, conver to string.  This will break value binding with bind_func and bind_ptr. (This function will reset commit)
        *
        ...
        */
        template <typename T>
        AttrInteger &operator=(const T &attr) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrInteger.set with no implementation. Reset value.")
            return *this;
        }
        ...
        */
        ...
        void bind(std::function<const T()>bind_func) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrInteger.bind with no implementation. Reset value.")
        }
        /**
        * Bind attribute to a function. This will break value binding with bind_ptr. (This function will reset commit)
        *
        ...
        */
        template <typename T>
        AttrInteger &operator[](std::function<const T()>bind_func) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrInteger.bind with no implementation. Reset value.")
            return *this;
        }
        ...
        */
        template <typename T>
        AttrInteger &operator[](const std::weak_ptr<T> &bind_ptr) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrInteger.bind with no implementation. Reset value.")
            return *this;
        }
    ...
    private:
        ...
        /**
        * Convert integer to string of AttrInteger.
        */
    ...
    public:
        ...
        */
        void set(const int &attr) {
            ...
            _commit = std::bind(&AttrInteger::_from_con_val_integer, this);
            _on_assign(_last);
        }
        /**
        * Set attribute from integer, conver to string.  This will break value binding with bind_func and bind_ptr.
        ...
        * @param attr integer attribute.
        */
        AttrInteger &operator=(const int &attr) {
            _con_val_integer = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrInteger::_from_con_val_integer, this);
            _on_assign(_last);
        ...
        */
        void bind(std::function<const int()> bind_func) {
            ...
            _commit = std::bind(&AttrInteger::_from_bind_func_integer, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a integer function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrInteger &operator[](std::function<const int()> bind_func) {
            _bind_func_integer = bind_func;
            _commit = std::bind(&AttrInteger::_from_bind_func_integer, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<int> &bind_ptr) {
            ...
            _commit = std::bind(&AttrInteger::_from_bind_ptr_integer, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a integer pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrInteger &operator[](const std::weak_ptr<int> &bind_ptr) {
            _bind_ptr_integer = bind_ptr;
            _commit = std::bind(&AttrInteger::_from_bind_ptr_integer, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert long to string of AttrInteger.
        */
    ...
    public:
        ...
        */
        void set(const long &attr) {
            _con_val_long = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrInteger::_from_con_val_long, this);
            _on_assign(_last);
        }
        /**
        * Set attribute from long, conver to string.  This will break value binding with bind_func and bind_ptr.
        ...
        * @param attr long attribute.
        */
        AttrInteger &operator=(const long &attr) {
            _con_val_long = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrInteger::_from_con_val_long, this);
            _on_assign(_last);
        ...
        */
        void bind(std::function<const long()> bind_func) {
            ...
            _commit = std::bind(&AttrInteger::_from_bind_func_long, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a long function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrInteger &operator[](std::function<const long()> bind_func) {
            _bind_func_long = bind_func;
            _commit = std::bind(&AttrInteger::_from_bind_func_long, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<long> &bind_ptr) {
            ...
            _commit = std::bind(&AttrInteger::_from_bind_ptr_long, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a long pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrInteger &operator[](const std::weak_ptr<long> &bind_ptr) {
            _bind_ptr_long = bind_ptr;
            _commit = std::bind(&AttrInteger::_from_bind_ptr_long, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert long integer to string of AttrInteger.
        */
    ...
    public:
        ...
        */
        void set(const long long int &attr) {
            ...
            auto _last = get_commit();
            _commit = std::bind(&AttrInteger::_from_con_val_long_integer, this);
            _on_assign(_last);
        }
        /**
        * Set attribute from long integer, conver to string.  This will break value binding with bind_func and bind_ptr.
        ...
        * @param attr long integer attribute.
        */
        AttrInteger &operator=(const long long int &attr) {
            _con_val_long_integer = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrInteger::_from_con_val_long_integer, this);
            _on_assign(_last);
        ...
        */
        void bind(std::function<const long long int()> bind_func) {
            ...
            _commit = std::bind(&AttrInteger::_from_bind_func_long_integer, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a long integer function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrInteger &operator[](std::function<const long long int()> bind_func) {
            _bind_func_long_integer = bind_func;
            _commit = std::bind(&AttrInteger::_from_bind_func_long_integer, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<long long int> &bind_ptr) {
            ...
            _commit = std::bind(&AttrInteger::_from_bind_ptr_long_integer, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a long integer pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrInteger &operator[](const std::weak_ptr<long long int> &bind_ptr) {
            _bind_ptr_long_integer = bind_ptr;
            _commit = std::bind(&AttrInteger::_from_bind_ptr_long_integer, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert legal string to string of AttrInteger.
        */
    ...
    public:
        ...
        */
        void set(const std::string &attr) {
            ...
            auto _last = get_commit();
            _commit = std::bind(&AttrInteger::_from_con_val_legal_string, this);
            _on_assign(_last);
        }
        /**
        * Set attribute from legal string, conver to string.  This will break value binding with bind_func and bind_ptr.
        ...
        * @param attr legal string attribute.
        */
        AttrInteger &operator=(const std::string &attr) {
            _con_val_legal_string = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrInteger::_from_con_val_legal_string, this);
            _on_assign(_last);
        ...
        * @param attr legal string attribute.
        */
        AttrInteger &operator=(const char * attr) {
        ...
        */
        void bind(std::function<const std::string()> bind_func) {
            ...
            _commit = std::bind(&AttrInteger::_from_bind_func_legal_string, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a legal string function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrInteger &operator[](std::function<const std::string()> bind_func) {
            _bind_func_legal_string = bind_func;
            _commit = std::bind(&AttrInteger::_from_bind_func_legal_string, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<std::string> &bind_ptr) {
            ...
            _commit = std::bind(&AttrInteger::_from_bind_ptr_legal_string, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a legal string pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrInteger &operator[](const std::weak_ptr<std::string> &bind_ptr) {
            _bind_ptr_legal_string = bind_ptr;
            _commit = std::bind(&AttrInteger::_from_bind_ptr_legal_string, this);
            _on_bind_ptr();
            return *this;
