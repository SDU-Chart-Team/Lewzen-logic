#ifndef __LZ_ATTR_COORDINATE__
#define __LZ_ATTR_COORDINATE__
#include <functional>
#include <string>
#include <memory>
#include <iostream>
    ...
    */
    ...
    public:
        ...
        */
        AttrCoordinate() {}
        /**
        * Constructor of Coordinate, with binding with getter and setter.
        *
        * @param getter getter function
        * @param setter setter function
        */
        AttrCoordinate(std::function<const std::string()> getter, std::function<void(const std::string &)> setter): _getter(getter), _setter(setter) {}

        /**
        * Set getter of Coordinate this attribute.
        * @param getter getter function
        */
        ...
        /**
        * Set setter of Coordinate this attribute.
        *
        * @param setter setter function
        */
    ...
    private:
        ...
        /**
        * Convert integer to string of AttrCoordinate.
        */
    ...
    public:
        ...
        * @param attr integer attribute.
        */
        AttrCoordinate &operator=(const int &attr) {
            _con_val_integer = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrCoordinate::_from_con_val_integer, this);
            _on_assign(_last);
        ...
        */
        void bind(std::function<const int()> bind_func) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_func_integer, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a integer function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrCoordinate &operator[](std::function<const int()> bind_func) {
            _bind_func_integer = bind_func;
            _commit = std::bind(&AttrCoordinate::_from_bind_func_integer, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<int> &bind_ptr) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_integer, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a integer pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrCoordinate &operator[](const std::weak_ptr<int> &bind_ptr) {
            _bind_ptr_integer = bind_ptr;
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_integer, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert float to string of AttrCoordinate.
        */
    ...
    public:
        ...
        * @param attr float attribute.
        */
        AttrCoordinate &operator=(const float &attr) {
            _con_val_float = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrCoordinate::_from_con_val_float, this);
            _on_assign(_last);
        ...
        */
        void bind(std::function<const float()> bind_func) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_func_float, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a float function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrCoordinate &operator[](std::function<const float()> bind_func) {
            _bind_func_float = bind_func;
            _commit = std::bind(&AttrCoordinate::_from_bind_func_float, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<float> &bind_ptr) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_float, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a float pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrCoordinate &operator[](const std::weak_ptr<float> &bind_ptr) {
            _bind_ptr_float = bind_ptr;
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_float, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert double to string of AttrCoordinate.
        */
    ...
    public:
        ...
        * @param attr double attribute.
        */
        AttrCoordinate &operator=(const double &attr) {
            _con_val_double = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrCoordinate::_from_con_val_double, this);
            _on_assign(_last);
        ...
        */
        void bind(std::function<const double()> bind_func) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_func_double, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a double function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrCoordinate &operator[](std::function<const double()> bind_func) {
            _bind_func_double = bind_func;
            _commit = std::bind(&AttrCoordinate::_from_bind_func_double, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<double> &bind_ptr) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_double, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a double pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrCoordinate &operator[](const std::weak_ptr<double> &bind_ptr) {
            _bind_ptr_double = bind_ptr;
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_double, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert long to string of AttrCoordinate.
        */
    ...
    public:
        ...
        * @param attr long attribute.
        */
        AttrCoordinate &operator=(const long &attr) {
            _con_val_long = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrCoordinate::_from_con_val_long, this);
            _on_assign(_last);
        ...
        */
        void bind(std::function<const long()> bind_func) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_func_long, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a long function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrCoordinate &operator[](std::function<const long()> bind_func) {
            _bind_func_long = bind_func;
            _commit = std::bind(&AttrCoordinate::_from_bind_func_long, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<long> &bind_ptr) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_long, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a long pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrCoordinate &operator[](const std::weak_ptr<long> &bind_ptr) {
            _bind_ptr_long = bind_ptr;
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_long, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert long integer to string of AttrCoordinate.
        */
    ...
    public:
        ...
        * @param attr long integer attribute.
        */
        AttrCoordinate &operator=(const long long int &attr) {
            _con_val_long_integer = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrCoordinate::_from_con_val_long_integer, this);
            _on_assign(_last);
        ...
        */
        void bind(std::function<const long long int()> bind_func) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_func_long_integer, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a long integer function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrCoordinate &operator[](std::function<const long long int()> bind_func) {
            _bind_func_long_integer = bind_func;
            _commit = std::bind(&AttrCoordinate::_from_bind_func_long_integer, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<long long int> &bind_ptr) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_long_integer, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a long integer pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrCoordinate &operator[](const std::weak_ptr<long long int> &bind_ptr) {
            _bind_ptr_long_integer = bind_ptr;
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_long_integer, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert long double to string of AttrCoordinate.
        */
    ...
    public:
        ...
        * @param attr long double attribute.
        */
        AttrCoordinate &operator=(const long double &attr) {
            _con_val_long_double = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrCoordinate::_from_con_val_long_double, this);
            _on_assign(_last);
        ...
        */
        void bind(std::function<const long double()> bind_func) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_func_long_double, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a long double function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrCoordinate &operator[](std::function<const long double()> bind_func) {
            _bind_func_long_double = bind_func;
            _commit = std::bind(&AttrCoordinate::_from_bind_func_long_double, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<long double> &bind_ptr) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_long_double, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a long double pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrCoordinate &operator[](const std::weak_ptr<long double> &bind_ptr) {
            _bind_ptr_long_double = bind_ptr;
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_long_double, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert legal string to string of AttrCoordinate.
        */
    ...
    public:
        ...
        * @param attr legal string attribute.
        */
        AttrCoordinate &operator=(const std::string &attr) {
            _con_val_legal_string = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrCoordinate::_from_con_val_legal_string, this);
            _on_assign(_last);
        ...
        */
        void bind(std::function<const std::string()> bind_func) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_func_legal_string, this);
            _on_bind_func();
        }
        /**
        * Bind attribute to a legal string function. This will break value binding with bind_ptr.
        ...
        * @param bind_func binding function.
        */
        AttrCoordinate &operator[](std::function<const std::string()> bind_func) {
            _bind_func_legal_string = bind_func;
            _commit = std::bind(&AttrCoordinate::_from_bind_func_legal_string, this);
            _on_bind_func();
            return *this;
        ...
        */
        void bind(const std::weak_ptr<std::string> &bind_ptr) {
            ...
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_legal_string, this);
            _on_bind_ptr();
        }
        /**
        * Bind attribute to a legal string pointer. This will break value binding with bind_func.
        ...
        * @param bind_ptr binding pointer.
        */
        AttrCoordinate &operator[](const std::weak_ptr<std::string> &bind_ptr) {
            _bind_ptr_legal_string = bind_ptr;
            _commit = std::bind(&AttrCoordinate::_from_bind_ptr_legal_string, this);
            _on_bind_ptr();
            return *this;
        ...
        /**
        * Check if a string is legal as a Coordinate attribute.
        */
