#ifndef __LZ_ATTR_NAME__
#define __LZ_ATTR_NAME__
#include <functional>
#include <string>
#include <memory>
#include <iostream>
...
namespace Lewzen {
    ...
    */
    ...
    public:
        /**
        * Empty constructor of Name.
        */
        AttrName() {}
        /**
        * Constructor of Name, with binding with getter and setter.
        *
        * @param getter getter function
        * @param setter setter function
        */
        AttrName(std::function<const std::string()> getter, std::function<void(const std::string &)> setter): _getter(getter), _setter(setter) {}

        /**
        * Set getter of Name this attribute.
        * @param getter getter function
        */
        ...
        /**
        * Set setter of Name this attribute.
        *
        * @param setter setter function
        */
    ...
    public:
        ...
        */
        template <typename T>
        AttrName &operator=(const T &attr) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrName.set with no implementation. Reset value.")
            return *this;
        }
        ...
        */
        ...
        void bind(std::function<const T()>bind_func) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrName.bind with no implementation. Reset value.")
        }
        /**
        * Bind attribute to a function. This will break value binding with bind_ptr. (This function will reset commit)
        *
        ...
        */
        template <typename T>
        AttrName &operator[](std::function<const T()>bind_func) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrName.bind with no implementation. Reset value.")
            return *this;
        }
        ...
        */
        template <typename T>
        AttrName &operator[](const std::weak_ptr<T> &bind_ptr) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrName.bind with no implementation. Reset value.")
            return *this;
        }
    ...
    private:
        ...
        /**
        * Convert legal string to string of AttrName.
        */
    ...
    public:
        ...
        * @param attr legal string attribute.
        */
        AttrName &operator=(const std::string &attr) {
            _con_val_legal_string = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrName::_from_con_val_legal_string, this);
            _on_assign(_last);
        ...
        * @param attr legal string attribute.
        */
        AttrName &operator=(const char * attr) {
        ...
        * @param bind_func binding function.
        */
        AttrName &operator[](std::function<const std::string()> bind_func) {
            _bind_func_legal_string = bind_func;
            _commit = std::bind(&AttrName::_from_bind_func_legal_string, this);
            _on_bind_func();
            return *this;
        ...
        * @param bind_ptr binding pointer.
        */
        AttrName &operator[](const std::weak_ptr<std::string> &bind_ptr) {
            _bind_ptr_legal_string = bind_ptr;
            _commit = std::bind(&AttrName::_from_bind_ptr_legal_string, this);
            _on_bind_ptr();
            return *this;
        ...
        /**
        * Check if a string is legal as a Name attribute.
        */
