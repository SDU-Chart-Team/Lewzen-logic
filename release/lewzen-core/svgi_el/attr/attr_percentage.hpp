...
namespace Lewzen {
    ...
    */
    ...
    public:
        ...
        */
        AttrPercentage(std::function<const std::string()> getter, std::function<void(const std::string &)> setter): _getter(getter), _setter(setter) {}
    ...
    private:
        ...
        /**
        * Convert integer to string of AttrPercentage.
        */
    ...
    public:
        ...
        * @param attr integer attribute.
        */
        AttrPercentage &operator=(const int &attr) {
            _con_val_integer = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrPercentage::_from_con_val_integer, this);
            _on_assign(_last);
        ...
        * @param bind_func binding function.
        */
        AttrPercentage &operator[](std::function<const int()> bind_func) {
            _bind_func_integer = bind_func;
            _commit = std::bind(&AttrPercentage::_from_bind_func_integer, this);
            _on_bind_func();
            return *this;
        ...
        * @param bind_ptr binding pointer.
        */
        AttrPercentage &operator[](const std::weak_ptr<int> &bind_ptr) {
            _bind_ptr_integer = bind_ptr;
            _commit = std::bind(&AttrPercentage::_from_bind_ptr_integer, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert float to string of AttrPercentage.
        */
    ...
    public:
        ...
        * @param attr float attribute.
        */
        AttrPercentage &operator=(const float &attr) {
            _con_val_float = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrPercentage::_from_con_val_float, this);
            _on_assign(_last);
        ...
        * @param bind_func binding function.
        */
        AttrPercentage &operator[](std::function<const float()> bind_func) {
            _bind_func_float = bind_func;
            _commit = std::bind(&AttrPercentage::_from_bind_func_float, this);
            _on_bind_func();
            return *this;
        ...
        * @param bind_ptr binding pointer.
        */
        AttrPercentage &operator[](const std::weak_ptr<float> &bind_ptr) {
            _bind_ptr_float = bind_ptr;
            _commit = std::bind(&AttrPercentage::_from_bind_ptr_float, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert double to string of AttrPercentage.
        */
    ...
    public:
        ...
        * @param attr double attribute.
        */
        AttrPercentage &operator=(const double &attr) {
            _con_val_double = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrPercentage::_from_con_val_double, this);
            _on_assign(_last);
        ...
        * @param bind_func binding function.
        */
        AttrPercentage &operator[](std::function<const double()> bind_func) {
            _bind_func_double = bind_func;
            _commit = std::bind(&AttrPercentage::_from_bind_func_double, this);
            _on_bind_func();
            return *this;
        ...
        * @param bind_ptr binding pointer.
        */
        AttrPercentage &operator[](const std::weak_ptr<double> &bind_ptr) {
            _bind_ptr_double = bind_ptr;
            _commit = std::bind(&AttrPercentage::_from_bind_ptr_double, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert long to string of AttrPercentage.
        */
    ...
    public:
        ...
        * @param attr long attribute.
        */
        AttrPercentage &operator=(const long &attr) {
            _con_val_long = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrPercentage::_from_con_val_long, this);
            _on_assign(_last);
        ...
        * @param bind_func binding function.
        */
        AttrPercentage &operator[](std::function<const long()> bind_func) {
            _bind_func_long = bind_func;
            _commit = std::bind(&AttrPercentage::_from_bind_func_long, this);
            _on_bind_func();
            return *this;
        ...
        * @param bind_ptr binding pointer.
        */
        AttrPercentage &operator[](const std::weak_ptr<long> &bind_ptr) {
            _bind_ptr_long = bind_ptr;
            _commit = std::bind(&AttrPercentage::_from_bind_ptr_long, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert long integer to string of AttrPercentage.
        */
    ...
    public:
        ...
        * @param attr long integer attribute.
        */
        AttrPercentage &operator=(const long long int &attr) {
            _con_val_long_integer = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrPercentage::_from_con_val_long_integer, this);
            _on_assign(_last);
        ...
        * @param bind_func binding function.
        */
        AttrPercentage &operator[](std::function<const long long int()> bind_func) {
            _bind_func_long_integer = bind_func;
            _commit = std::bind(&AttrPercentage::_from_bind_func_long_integer, this);
            _on_bind_func();
            return *this;
        ...
        * @param bind_ptr binding pointer.
        */
        AttrPercentage &operator[](const std::weak_ptr<long long int> &bind_ptr) {
            _bind_ptr_long_integer = bind_ptr;
            _commit = std::bind(&AttrPercentage::_from_bind_ptr_long_integer, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert long double to string of AttrPercentage.
        */
    ...
    public:
        ...
        * @param attr long double attribute.
        */
        AttrPercentage &operator=(const long double &attr) {
            _con_val_long_double = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrPercentage::_from_con_val_long_double, this);
            _on_assign(_last);
        ...
        * @param bind_func binding function.
        */
        AttrPercentage &operator[](std::function<const long double()> bind_func) {
            _bind_func_long_double = bind_func;
            _commit = std::bind(&AttrPercentage::_from_bind_func_long_double, this);
            _on_bind_func();
            return *this;
        ...
        * @param bind_ptr binding pointer.
        */
        AttrPercentage &operator[](const std::weak_ptr<long double> &bind_ptr) {
            _bind_ptr_long_double = bind_ptr;
            _commit = std::bind(&AttrPercentage::_from_bind_ptr_long_double, this);
            _on_bind_ptr();
            return *this;
    ...
    private:
        ...
        /**
        * Convert legal string to string of AttrPercentage.
        */
    ...
    public:
        ...
        * @param attr legal string attribute.
        */
        AttrPercentage &operator=(const std::string &attr) {
            _con_val_legal_string = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrPercentage::_from_con_val_legal_string, this);
            _on_assign(_last);
        ...
        * @param bind_func binding function.
        */
        AttrPercentage &operator[](std::function<const std::string()> bind_func) {
            _bind_func_legal_string = bind_func;
            _commit = std::bind(&AttrPercentage::_from_bind_func_legal_string, this);
            _on_bind_func();
            return *this;
        ...
        * @param bind_ptr binding pointer.
        */
        AttrPercentage &operator[](const std::weak_ptr<std::string> &bind_ptr) {
            _bind_ptr_legal_string = bind_ptr;
            _commit = std::bind(&AttrPercentage::_from_bind_ptr_legal_string, this);
            _on_bind_ptr();
            return *this;
