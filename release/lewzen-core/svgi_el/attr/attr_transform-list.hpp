#ifndef __LZ_ATTR_TRANSFORM_LIST__
#define __LZ_ATTR_TRANSFORM_LIST__
#include <functional>
#include <string>
#include <memory>
#include <iostream>
...
namespace Lewzen {
    ...
    */
    ...
    public:
        /**
        * Empty constructor of TransformList.
        */
        AttrTransformList() {}
        /**
        * Constructor of TransformList, with binding with getter and setter.
        *
        * @param getter getter function
        * @param setter setter function
        */
        AttrTransformList(std::function<const std::string()> getter, std::function<void(const std::string &)> setter): _getter(getter), _setter(setter) {}

        /**
        * Set getter of TransformList this attribute.
        * @param getter getter function
        */
        ...
        /**
        * Set setter of TransformList this attribute.
        *
        * @param setter setter function
        */
    ...
    public:
        ...
        */
        template <typename T>
        AttrTransformList &operator=(const T &attr) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrTransformList.set with no implementation. Reset value.")
            return *this;
        }
        ...
        */
        ...
        void bind(std::function<const T()>bind_func) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrTransformList.bind with no implementation. Reset value.")
        }
        /**
        * Bind attribute to a function. This will break value binding with bind_ptr. (This function will reset commit)
        *
        ...
        */
        template <typename T>
        AttrTransformList &operator[](std::function<const T()>bind_func) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrTransformList.bind with no implementation. Reset value.")
            return *this;
        }
        ...
        */
        template <typename T>
        AttrTransformList &operator[](const std::weak_ptr<T> &bind_ptr) {
            _setter(STR_NULL);
            _LZ_WARNING("Calling AttrTransformList.bind with no implementation. Reset value.")
            return *this;
        }
    ...
    private:
        ...
        /**
        * Convert string to string of AttrTransformList.
        */
    ...
    public:
        ...
        * @param attr string attribute.
        */
        AttrTransformList &operator=(const std::string &attr) {
            _con_val_string = attr;
            auto _last = get_commit();
            _commit = std::bind(&AttrTransformList::_from_con_val_string, this);
            _on_assign(_last);
        ...
        * @param attr string attribute.
        */
        AttrTransformList &operator=(const char * attr) {
        ...
        * @param bind_func binding function.
        */
        AttrTransformList &operator[](std::function<const std::string()> bind_func) {
            _bind_func_string = bind_func;
            _commit = std::bind(&AttrTransformList::_from_bind_func_string, this);
            _on_bind_func();
            return *this;
        ...
        * @param bind_ptr binding pointer.
        */
        AttrTransformList &operator[](const std::weak_ptr<std::string> &bind_ptr) {
            _bind_ptr_string = bind_ptr;
            _commit = std::bind(&AttrTransformList::_from_bind_ptr_string, this);
            _on_bind_ptr();
            return *this;
