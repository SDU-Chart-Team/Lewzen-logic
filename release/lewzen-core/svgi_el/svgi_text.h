...
namespace Lewzen {
    ...
    */
    ...
    private:
        ...
        using SVGText::get_y;
        using SVGText::set_y;
        using SVGText::get_dx;
        using SVGText::set_dx;
        using SVGText::get_dy;
        using SVGText::set_dy;
        using SVGText::get_rotate;
        using SVGText::set_rotate;
        using SVGText::get_length_adjust;
        using SVGText::set_length_adjust;
        using SVGText::get_text_length;
        using SVGText::set_text_length;
