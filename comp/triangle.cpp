...
namespace LewzenServer
{
    ...
    //// Basics
    //
    void Triangle::moveCorePoint(const std::string &id, const double &_dx, const double &_dy)
    {
    ...
    ////
    std::string Triangle::getD() const
    {
        return "M " + std::to_string(LT->getX()) + " " + std::to_string(LT->getY()) + " " + "L " + std::to_string(R->getX()) + " " + std::to_string(R->getY()) + " " + "L " + std::to_string(LB->getX()) + " " + std::to_string(LB->getY()) + " Z";
    }
}
