...
namespace LewzenServer
{
    ...
    void Diamond::init()
    {
        ...
        //
        std::function<std::string()> _getD = std::bind(&Diamond::getD, this);
    ...
    //// Basics
    //
    void Diamond::moveCorePoint(const std::string &id, const double &_dx, const double &_dy)
    {
    ...
    ////
    std::string Diamond::getD() const
    {
        return "M " + std::to_string(T->getX()) + " " + std::to_string(T->getY()) + " " + "L " + std::to_string(R->getX()) + " " + std::to_string(R->getY()) + " " + "L " + std::to_string(B->getX()) + " " + std::to_string(B->getY()) + " " + "L " + std::to_string(L->getX()) + " " + std::to_string(L->getY()) + " Z";
    }
}
