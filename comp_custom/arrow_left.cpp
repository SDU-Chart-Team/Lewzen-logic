...
namespace LewzenServer
{
    ...
    void ArrowLeft::init()
    {
        ...
        SVGIG->add(SVGIPath);
        Control0 = createCorePoint("Control0", getX() + getWidth() * 0.4, getY() + getHeight() * 0.75);
    ...
    const std::string ArrowLeft::getPath() const
    {
        ...
        auto p2 = createPoint(Control0->getX(), getY() + getHeight() - (Control0->getY() - getY()));
        auto p3 = createPoint(getX() + getWidth(), getY() + getHeight() - (Control0->getY() - getY()));
        auto p4 = createPoint(getX() + getWidth(), Control0->getY());
        auto p5 = createPoint(Control0->getX(), Control0->getY());
        auto p6 = createPoint(Control0->getX(), getY() + getHeight());
        auto p7 = createPoint(getX(), getY() + getHeight() * 0.5);
        std::stringstream ss;
